            ...
            >
              <template #content="{ item }">
                ...
                <div v-else-if="item.value === 'criteria'" class="space-y-6">
                  <!-- Параметри цінового критерія -->
          <div v-if="false" class="border border-gray-200 rounded-lg p-4 bg-gray-50/50">
                    <h4 class="text-sm font-semibold text-gray-700 mb-3">
                      Параметри цінового критерія
                    </h4>
                    <div class="flex flex-wrap gap-6">
                  ...
                  <div class="flex gap-4 min-h-0 flex-1">
                    ...
                    <div
                      class="flex-1 min-w-0 flex flex-col border border-gray-200 rounded-lg p-4 bg-white"
                    >
...
async function submitResumeAcceptance() {
  ...
  try {
    const ok = await patchTender({
      stage: "acceptance",
      start_at: inputToIso(resumeAcceptanceForm.start_at),
      end_at: inputToIso(resumeAcceptanceForm.end_at),
    });
    if (ok) {
